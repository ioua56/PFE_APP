...
class Model6Classification:
    modality="ct"
    def configure(self):
        self.model = load_model('daliprediction.h5') 
        self.model.summary()
        self.size=(224,224)
    ...
    def run(self,data):
        ...
        if rs[0][0] >=0.5 :
            prediction = 'This image is NOT tumorous. from model 4'
        else:
            prediction = 'Warning! This image IS tumorous. from model 4'
        
        
        return prediction

repo = Repository()
repo.register('classification6', Model6Classification())  
