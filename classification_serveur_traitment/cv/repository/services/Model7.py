...
class Model7Classification:
    ...
    def run(self,data):
        ...
        if rs[0][0] >=0.5 :
            prediction = 'This image is NOT tumorous. from model 7'
        else:
            prediction = 'Warning! This image IS tumorous. from model 7'
        
        print(prediction)
        return {'hello': prediction}

repo = Repository()
repo.register('classification7', Model7Classification())  
