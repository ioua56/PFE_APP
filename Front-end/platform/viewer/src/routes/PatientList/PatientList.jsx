...
import {
  ...
  Typography,
  clearFilters,
} from '../../../../ui/src/components/index.js';
...
function PatientList({
  ...
  // bool variable if search button was pressed
  const [searchPressed, setSearchPressed] = useState(false);
  //Search button presseed
  const handleSearch = () => {
  ...
  // function onClick for search button

  //bool variable if Search button is pressed
